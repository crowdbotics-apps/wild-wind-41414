"""
Django settings for wild_wind_41414 project.
...
ROOT_URLCONF = 'wild_wind_41414.urls'
...
WSGI_APPLICATION = 'wild_wind_41414.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wild_wind_41414 API",
    "DESCRIPTION": "API documentation for wild_wind_41414 App",
    "VERSION": "v1",
}
